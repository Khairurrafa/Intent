package com.khairurrafa.intentparcelble;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Muhammad Khairurrafa Erlangga");
            ...
            case R.id.btn_move_activity_object:
                ...
                mPerson.setName("Muhammad Khairurrafa Erlangga");
                mPerson.setAge(17);
                mPerson.setEmail("1920118120.siswa@smkn4bdg.sch.id");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "081905639178";
